...
public class OraclePaginationPlugin extends PluginAdapter {
    ...
    private void addPage(TopLevelClass topLevelClass, IntrospectedTable introspectedTable,
                         String name) {
        topLevelClass.addImportedType(new FullyQualifiedJavaType("com.ipaynow.npacc.mybatis_plugin.Page"));
        CommentGenerator commentGenerator = context.getCommentGenerator();
        Field field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(new FullyQualifiedJavaType("com.ipaynow.npacc.mybatis_plugin.Page"));
        field.setName(name);
        ...
        method.addParameter(new Parameter(new FullyQualifiedJavaType("com.ipaynow.npacc.mybatis_plugin.Page"), name));
        method.addBodyLine("this." + name + "=" + name + ";");
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setReturnType(new FullyQualifiedJavaType("com.ipaynow.npacc.mybatis_plugin.Page"));
