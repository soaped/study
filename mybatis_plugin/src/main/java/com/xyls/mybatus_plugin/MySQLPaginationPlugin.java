...
/**
 * generatorConfig中增加
 * <plugin type="com.ipaynow.npacc.common_util.mybatis_plugin.MySQLPaginationPlugin"></plugin>
...
public final class MySQLPaginationPlugin extends PluginAdapter {
    ...
    private void addPage(TopLevelClass topLevelClass, IntrospectedTable introspectedTable,
                         String name) {
        topLevelClass.addImportedType(new FullyQualifiedJavaType("com.xyls.mybatus_plugin.Page"));
        CommentGenerator commentGenerator = context.getCommentGenerator();
        Field field = new Field();
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(new FullyQualifiedJavaType("com.xyls.mybatus_plugin.Page"));
        field.setName(name);
        ...
        //TODO:分页类名
        method.addParameter(new Parameter(new FullyQualifiedJavaType("com.xyls.mybatus_plugin.Page"), name));
        method.addBodyLine("this." + name + "=" + name + ";");
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);
        method = new Method();
        method.setVisibility(JavaVisibility.PUBLIC);
        method.setReturnType(new FullyQualifiedJavaType("com.xyls.mybatus_plugin.Page"));
